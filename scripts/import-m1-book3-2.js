#!/usr/bin/env node
/**
 * Import M1 income + expenses from M1_book3_2.pdf (dual-page: L/top=expense, R/bottom=income)
 */
const fs = require('fs');
...
const tmp = path.join(root, 'tmp/m1-book3-2');
const TAG = 'imported from M1_book3_2.pdf';
...
console.log('M1 import from M1_book3_2.pdf');
